...
export default class MovieList extends Component {
    ...
    renderMovie = () => {
        const html = this.movie.map((item) => {
            return (
                <div key={item.maPhim} className={style.col}>
                    <div className={style.item}>
                        <img className={style.img} src={item.hinhAnh} />
    ...
    render() {
        return (
            <div className={style.container}>
                <h1 className={style.title}>DANH SACH PHIM</h1>
